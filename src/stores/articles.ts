  ...
  const articles = ref([
    {
      ...
      url: 'https://medium.com/@revanthkumarpatha/mastering-vue-3-6s-alien-signals-practical-examples-and-use-cases-7df02a159d8a'
    },
    {
      id: 14,
      title: 'Mastering New Vue 3.5 Features: Reactive Props Destructure, useId(), defineExpose, and unref',
      Author: 'Revanth Kumar Patha',
      linkedIn: 'https://www.linkedin.com/in/revanth-kumar-9246841a0/',
      url: 'https://medium.com/@revanthkumarpatha/mastering-new-vue-3-5-features-reactive-props-destructure-useid-defineexpose-and-unref-76be7aa50ea8'
    },
